        ...
        success:function(res){
            if(res.code == 0){
                ...
                if (logo ==undefined || logo == '' || logo== null) {
                    logo = ROOT_URL + '/assets/images/index/ai_service.png';
                }
                var str='';
                ...
                str+='<p style="font-weight:blod;">'+guess_ask+'</p>'
                var num ='';
                ...
                $.each(res.data,function(k,v){
                    ...
                    str+='<div class="question" onclick="getanswer('+v.qid+',`'+v.question+'`)">'+v.question+'</div>';
                    if ( v.keyword != '') {
...
var loginout = function () {
    ...
    $.ajax({
        url:ROOT_URL+"/admin/event/qdelete",
        type: "post",
