...
<div class="container">
    <div class="header clearfix">
        <h3 class="text-muted">源码分享站ymfxz.com</h3>
    </div>
    <script>
    ...
    <?php elseif ($step == 3): ?>
        ...
        <?php else: ?>
            ...
            if($result){
                mysqli_query($link, "insert into wolive_business(business_name)value('{$adminUser}')");

                $pass_md5 = md5($adminUser . "hjkj" . $adminPass);

                mysqli_query($link, "insert into wolive_service(business_id,level,user_name,nick_name,password)value('1','super_manager','{$adminUser}','客服小美','{$pass_md5}')");
            }
...
");
    ...
    <?php else: ?>
        ...
        <div class="alert alert-success"><strong>已经安装成功ymfxz</strong></div>
...
<footer class="footer">
    <div class="container">
        <p class="text-muted">源码分享站ymfxz.com</p>
    </div>
</footer>
<!-- javascript -->
